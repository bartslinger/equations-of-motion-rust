...
const LT: f64 = 24.8; // Distance by AC of tail and body (m)
const S: f64 = 260.0; // Wing planform area (m^2)
const S_TAIL: f64 = 64.0; // Tail planform area (m^2)
const X_CG: f64 = 0.23 * CBAR; // x position of CoG in Fm (m)
const Y_CG: f64 = 0.0; // y position of CoG in Fm (m)
const Z_CG: f64 = 0.10 * CBAR; // z position of CoG in Fm (m)

const X_AC: f64 = 0.12 * CBAR; // x position of aerodynamic center in Fm (m)
const Y_AC: f64 = 0.0; // y position of aerodynamic center in Fm (m)
const Z_AC: f64 = 0.0; // z position of aerodynamic center in Fm (m)

// Engine inputs
const U_MAX: f64 = 120000.0 * 9.81; // maximum thrust provided by one engine (N)

const X_APT1: f64 = 0.0; // x position of engine 1 force in Fm (m)
const Y_APT1: f64 = -7.94; // y position of engine 1 force in Fm (m)
const Z_APT1: f64 = -1.9; // z position of engine 1 force in Fm (m)

const X_APT2: f64 = 0.0; // x position of engine 2 force in Fm (m)
const Y_APT2: f64 = 7.94; // y position of engine 2 force in Fm (m)
const Z_APT2: f64 = -1.9; // z position of engine 2 force in Fm (m)
